Scheme
{
	Colors
	{
		...
		// NOTO MENU COLORS
		"NotoMenu"				"70 130 180 255" //Main Color. Is usually the same color as NotoMenuBackground, NotoMenuBackgroundInGame, NotoBackground and NotoInGameBackground.
		...
		"NotoMenuBackground"	"70 130 180 255" //Main Menu Background. You can make this transparent to use your own custom image backgrounds.
		"NotoMenuBackgroundInGame"	"70 130 180 255" //Main Menu Background, while in game. This is good to make transparent!
		...
		"NotoInGameBackground"	"70 130 180 255" //Class + Team Selection, Map Info, etc. Also good to make transparent!
