Scheme
{
	...
	{		
		...
		// NOTO MENU COLORS
		"NotoMenu"				"205 50 50 255" //Main Color. Is usually the same color as NotoMenuBackground, NotoMenuBackgroundInGame, NotoBackground and NotoInGameBackground.
		...
		"NotoMenuBackground"	"205 50 50 255" //Main Menu Background. You can make this transparent to use your own custom image backgrounds.
		"NotoMenuBackgroundInGame"	"205 50 50 255" //Main Menu Background, while in game. This is good to make transparent!
		"NotoBackground"		"205 50 50 255" //Menu Backgrounds, Backpack, Crafting, MvM Lobby, etc. Wouldn't recommend ever making this transparent.
		"NotoInGameBackground"	"205 50 50 255" //Class + Team Selection, Map Info, etc. Also good to make transparent!
